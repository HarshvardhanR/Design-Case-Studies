...
public class Game {
    ...
    public void startGame(){
        while(winner==null){
            ...
            System.out.println("Player Id: " + playerTurn.getID() + " Current Position: " + playerTurn.getCurrentPosition());
            ...
            System.out.println("Player Id: " + playerTurn.getID() + " New Position: " + playerTurn.getCurrentPosition());

            if (playerTurn.getCurrentPosition() == board.getSize()){
                winner = playerTurn;
            }
            System.out.println("Winner is " + playerTurn.getID());
        }
    }
    ...
    public int checkValidity(int diceNumber, int currentPostion){
        int newPosition = currentPostion + diceNumber;
        if(newPosition > board.getSize()) return currentPostion;
        Cell cell = board.getCell(newPosition);
        if(cell.getProp()!=null && cell.getProp().getStart()==newPosition){
            String propType = (cell.getProp().getStart() < cell.getProp().getEnd()) ? "Ladder Encountered" : "Snake Encountered";
